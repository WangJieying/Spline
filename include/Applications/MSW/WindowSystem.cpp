...
{
    auto engine = std::make_shared<DX11Engine>(nullptr, parameters.handle,
        parameters.xSize, parameters.ySize, parameters.useDepth24Stencil8,
        D3D_DRIVER_TYPE_HARDWARE, nullptr, parameters.deviceCreationFlags);
